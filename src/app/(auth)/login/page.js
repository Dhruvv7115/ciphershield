...
const features = [
	{
		...
		desc: "Zero-trust architecture protecting your assets 24/7",
	},
	{
		icon: "⚡",
		title: "AI-Powered Detection",
		desc: "Sub-millisecond threat identification at enterprise scale",
	},
	{
		icon: "🌐",
		title: "Global Coverage",
		desc: "Operations across 40+ countries, always-on protection",
	},
];
				...
				<div style={{ maxWidth: 480 }}>
					...
					>
						...
						<span
							style={{
								background:
									"linear-gradient(135deg, #6366F1, #818CF8, #22D3EE)",
								backgroundClip: "text",
					...
					>
						Access your complete cybersecurity dashboard — monitor threats,
						manage services, and protect your enterprise with AI-powered
						intelligence.
					</p>
						...
						{features.map((f, i) => (
							<div
								...
								style={{
									...
									animation: mounted
										? `fadeSlideIn 0.5s cubic-bezier(0.16,1,0.3,1) ${i * 0.12}s both`
										: "none",
								}}
								onMouseEnter={(e) => {
			...
			>
				...
				<div
					...
					style={{
						...
						width: 1,
						background:
							"linear-gradient(180deg, transparent, rgba(99,102,241,0.2) 30%, rgba(99,102,241,0.2) 70%, transparent)",
					}}
				/>
				...
				<div
					style={{
						...
						maxWidth: 460,
						background:
							"linear-gradient(145deg, rgba(15,23,42,0.95) 0%, rgba(2,6,23,0.97) 100%)",
						...
						animation: mounted
							? "formIn 0.6s cubic-bezier(0.16,1,0.3,1) 0.1s both"
							: "none",
					}}
				>
					{/* Top accent bar */}
					<div
						style={{
							height: 3,
							background:
								"linear-gradient(90deg, transparent, #6366F1 30%, #818CF8 60%, #22D3EE 90%, transparent)",
						}}
					/>
					...
					<div style={{ padding: "32px 36px" }}>
						...
						<div
							...
							style={{ display: "none", marginBottom: 28 }}
						>
							<Link
								href="/"
								style={{
						...
						{error && (
							...
							>
								...
								<span
									style={{ fontSize: 13, color: "#FF3D5A", fontWeight: 500 }}
								>
									{error}
								</span>
							</div>
						...
						<form onSubmit={handleSubmit(onSubmit)}>
							{mode === "signup" && (
								<div style={{ marginBottom: 16 }}>
									...
									/>
									{errors.name && (
										<span style={{ fontSize: 11, color: "#FF3D5A" }}>
											Name is required
										</span>
									)}
								</div>
						...
						>
							<div
								style={{ flex: 1, height: 1, background: "rgba(51,65,85,0.5)" }}
							/>

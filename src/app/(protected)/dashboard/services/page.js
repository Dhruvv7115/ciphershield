...
export default function ServicesPage() {
	const { items: cartItems, addToCart, removeFromCart, totalItems, openCart, closeCart, toggleCart } = useCart();
			...
			<div className="dash-content">
				...
				>
					<div className="dash-header-left">
						...
						<p>
							Select services to customize your protection and automation stack.
						</p>
					</div>
				...
				{/* Filter & Search Bar */}
				<div
					className="dash-full-panel dash-animate dash-animate-2"
					style={{
						padding: "16px 20px",
						marginBottom: 24,
						display: "flex",
				...
				{loading ? (
					...
					>
						{filteredServices.map((service, index) => {
							...
							const iconKey = serviceIcons[service.number]
								? service.number
								: "07";

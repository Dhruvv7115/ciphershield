...
export default function LoginModal({ isOpen, onClose, onSuccess, message }) {
	...
	const inputStyle = (field) => ({
		...
		boxShadow:
			focused === field
				? "0 0 0 3px rgba(99,102,241,0.12), inset 0 1px 2px rgba(0,0,0,0.2)"
			...
			>
				<div
					style={{
						...
						overflow: "hidden",
						boxShadow:
							"0 40px 120px rgba(0,0,0,0.7), 0 0 0 1px rgba(99,102,241,0.08), inset 0 1px 0 rgba(255,255,255,0.04)",
					}}
				>
					{/* Top gradient accent */}
					<div
						style={{
							height: 3,
							background:
								"linear-gradient(90deg, transparent, #6366F1 20%, #818CF8 50%, #22D3EE 80%, transparent)",
						}}
					/>
							...
							{["login", "signup"].map((m) => (
								<button
									...
									style={{
										...
										boxShadow:
											mode === m ? "0 1px 0 rgba(99,102,241,0.2)" : "none",
										border:
											mode === m
